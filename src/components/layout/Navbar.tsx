...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          "fixed inset-x-0 top-16 z-[60] h-[calc(100dvh-4rem)] overflow-y-auto bg-[#f7f5f0] shadow-[0_18px_32px_rgba(26,58,42,0.14)] transition-all duration-300 ease-out xl:hidden",
          open
